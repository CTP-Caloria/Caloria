        ...
        return ( 
            <div className="footer">
                <div className="container">
                    <div className="row mb-2 mx-auto text-center">
                        <div className="col-md-3 col-sm-6 pt-4 pb-2 mx-auto">
                            <Link to="/about-us">
                                <button id="svg-btn" className="mx-5">
                            ...
                            <Link to={{ pathname: "https://github.com/CTP-Caloria/Caloria" }} target="_blank">
                                <button id="svg-btn" className="mx-5">
